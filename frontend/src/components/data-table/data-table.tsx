...
import DropdownContext from "@/components/data-table/dropdown-context";

interface DataTableProps {
    size?: number;
    metas: Field[];
    data: Row[];
    onMetaChange: (fid: string, fIndex: number, meta: Partial<Field>) => void;
}
                                    ...
                                    <DropdownContext
                                        ...
                                        onSelect={(value) => {
                                            onMetaChange(field.fid, fIndex, {
                                                semanticType: value as Field["semanticType"],
                                            });
                                        }}
                                    >
                                            <span
